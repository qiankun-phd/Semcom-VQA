...
As illustrated in Fig.~\ref{fig:framework_overview}(a), CART-Net comprises three input branches:
\begin{enumerate}
...
A key emergent property of CART-Net is that, without hard-coded thresholds, it autonomously partitions the physical SNR continuum into three distinct operational regimes (visualized in Fig.~\ref{fig:framework_overview}(b)):
