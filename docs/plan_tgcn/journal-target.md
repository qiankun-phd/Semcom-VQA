...
4. **Empirical**: Comprehensive comparison against **6 baselines**(MAPPO-hybrid, HAPPO, Hybrid-SAC, PADDPG, PDQN, Greedy upper bound)across **multi-UAV scaling、ablations、sensitivity、channel perturbation、UE-count generalization、adversarial jamming、large-scale UE**;MA-HPPO consistently dominates on joint cost, delay, energy, semantic similarity, and success rate.
