...
Files: `1458`
Total uncompressed bytes: `235070411`

## README / License

- README candidates: `['.~S-HSR-L：全息凝视雷达低空目标探测识别数据集使用说明-0507.docx', 'LSS-HSR-L：全息凝视雷达低空目标探测识别数据集使用说明-0507.docx', 'dataset.py']`
- License candidates: `[]`
...
| Gate | Status | Detail |
|---|---|---|
| `readme_or_usage` | `pass` | 3 README/usage candidates |
